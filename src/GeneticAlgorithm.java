...
public class GeneticAlgorithm {
	...
	ArrayList<Chromosome> testSet = new ArrayList<Chromosome>();
	...
	public void finalRun(int gen, ArrayList<Chromosome> list, int semlen) {
		...
		ArrayList<Chromosome> pool;
		ArrayList<Chromosome> toBreed;
		...
		while(i < gen) {
			...
			int prob = generator.nextInt(pool.size());
